...
'sanctum.csrf-cookie','api.shipmentTracking','api.shipmentCoordinates','api.companies.toggleMapOption',
'api.companies.toggleActive','api.companies.setTheme','api.companies.setImageAsset','api.companies.index','api.companies.store',
'api.companies.show','api.companies.update','api.companies.destroy','api.imageTypes.index','api.imageTypes.store',
'api.imageTypes.show','api.imageTypes.update','api.imageTypes.destroy','api.images.index','api.images.store',
'api.images.show','api.images.update','api.images.destroy','api.themes.index','api.themes.store',
'api.themes.show','api.themes.update','api.themes.destroy','api.impersonate.stop','api.admin.roles.assignPermissions',
'api.admin.roles.index','api.admin.roles.store','api.admin.roles.show','api.admin.roles.update','api.admin.roles.destroy',
'api.admin.users.update.role','api.admin.users.index','api.admin.users.store','api.admin.users.show','api.admin.users.update',
'api.admin.users.destroy','api.admin.impersonate.start','api.admin.permissions.index','api.admin.permissions.store','api.admin.permissions.show',
'api.admin.permissions.update','api.admin.permissions.destroy','api.admin.companyApiTokens.index','api.admin.companyApiTokens.store','api.admin.companyApiTokens.show',
'api.admin.companyApiTokens.update','api.admin.companyApiTokens.destroy','api.admin.allowedDomains.toggleActiveStatus','api.admin.allowedDomains.index','api.admin.allowedDomains.store',
'api.admin.allowedDomains.show','api.admin.allowedDomains.update','api.admin.allowedDomains.destroy','home',
'login','admin.companies.index','admin.companies.create','admin.companies.show','admin.themes.index',
'admin.themes.create','admin.themes.show','admin.image.index','admin.tracking.index','admin.allowed-domains.index',
'admin.users.index','admin.permissions.index','admin.permissions.show','admin.role.index','admin.role.show',
'trackShipment.index','trackShipment.notFound','oauth.redirect','oauth.callback','oauth.logout',
'storage.local',);
